...
GITHUB_REMOTE=git@github.com:fnproject/fdk-node.git
BITBUCKET_REMOTE=ssh://git@bitbucket.oci.oraclecorp.com:7999/faas/fdk-node.git
PUBLISH_BRANCH=github
TARGET_BRANCH=master
GIT_USER_EMAIL=ci@fnproject.com
GIT_USER_NAME=CI
SSH_KEY_SECRET=ocid1.vaultsecret.oc1.phx.amaaaaaaepf6idianbqtad2hyxogpjzj524ajwch37qz555rbtklkkxwdlgq
